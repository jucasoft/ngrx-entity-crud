...
export function createPersistenceEffects<T>(config: NecPersistenceEffectsConfig<T>): Type<NecPersistenceEffects> {
  ...
  class NecSectionPersistenceEffects implements NecPersistenceEffects {
    ...
    autoRestoreCheckOn$ = createEffect(() => defer(() => from(this.persistence.stats(feature))).pipe(
    ...
    restoreRequestOn$ = createEffect(() => this.actions$.pipe(
    ...
    searchRequestOn$ = createEffect(() => this.actions$.pipe(
      ofType(actions.SearchRequest),
      switchMap(() => from(this.persistence.purgeSection(feature)).pipe(catchError(() => EMPTY)))
    ), {dispatch: false});

    searchSuccessOn$ = createEffect(() => this.actions$.pipe(
    ...
    draftsPutOn$ = createEffect(() => merge(
