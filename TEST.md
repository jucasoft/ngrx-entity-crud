...
# costante) lo schematic lascia marcatori NEC_PASSO_MANUALE\_\__ / <nec-passo-manuale-_> e
...
# f. sezione form di ricerca + griglia (main con <app-<dash>-search>, es. product-browser):

# ng generate ngrx-entity-crud:persistence --clazz=ProductBrowser --enabled

# -> <app-product-browser-search> avvolto con <nec-restore-search ... layout="block">, nessun

# marcatore, main/list .ts toccati solo per la proprieta' persistence (nessuna ricerca in ngOnInit)

# -> il form resta a tutta larghezza, il toggle salvataggio sta sotto a destra
